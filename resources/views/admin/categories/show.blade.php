...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="sm:w-1/2 md:w-2/3 w-full ml-auto">
        <div class="flex flex-wrap -m-2">
          <div class="p-2 w-full">
            {{-- ボタン --}}
            <button
              onclick="location.href='{{ route('admin.categories.edit',['categoryId'=>$category->id]) }}'"
              class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8
    ...
    <div class="sm:w-1/2 md:w-2/3 w-full ml-auto mt-2">
        <div class="flex flex-wrap -m-2">
          <div class="p-2 w-full">
            {{-- ボタン --}}
            <button
          ...
          <tbody>
            {{-- @foreach($categories as $category) --}}
              <tr>
                ...
                <td class="px-4 py-3">2025-10-10 10:00</td>
